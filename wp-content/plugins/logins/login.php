<?php
/*
	Plugin Name: LoginForm
	Plugin URI: aimsdevelop.com
	Description: It is good to see for login and register ..
	Version: 1
	Author Name: Delowar Hossen
	Author URI: aimsdevelop.com
*/	

function register_js(){
	
	wp_enqueue_style('custom_js', plugin_dir_url(__FILE__).'style.css',false, '1.0');
	wp_enqueue_style('custom_plugin_css','https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js',true, '1.0');
	wp_enqueue_style('custom_js', plugin_dir_url(__FILE__).'jquery.js',array('jquery'), true);
}
add_action('wp_enqueue_scripts', 'register_js');
	
function register_login_and_reset_password(){
...
add_shortcode('login-register-form','register_login_and_reset_password');